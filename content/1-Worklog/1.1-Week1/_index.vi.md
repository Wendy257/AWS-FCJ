...
---
{{% notice warning %}} 
⚠️ **Lưu ý:** Thông tin dưới đây chỉ để tham khảo. Vui lòng **không sao chép nguyên văn** vào báo cáo của bạn, bao gồm cả thông báo này.
{{% /notice %}}
...
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | --------------- | ----------------------------------------- |
| 1 | I. Giới thiệu về Điện toán đám mây <br> &emsp; - Định nghĩa: Điện toán đám mây là việc cung cấp tài nguyên CNTT theo yêu cầu qua Internet với mô hình trả theo mức sử dụng. <br> &emsp; - Lợi ích chính: Tối ưu chi phí, tăng tốc/linh hoạt, dễ mở rộng và phạm vi toàn cầu. <br> &emsp; - Điểm khác biệt của AWS: Vị thế dẫn đầu thị trường, cam kết giảm giá (quy mô kinh tế), và phương thức lấy khách hàng làm trung tâm (Leadership Principles). |  |  | |
